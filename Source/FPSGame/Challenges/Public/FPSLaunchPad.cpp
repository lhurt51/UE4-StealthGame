...
{
	// Make rotator with our specified 'pitch' and convert to a direction vector * strength
	...
	if (OtherCharacter)
	{
		// Both booleans give consistent launch velocity by ignoring the current player velocity
